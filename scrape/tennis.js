...
const launchTennis = async () => {
    ...
    // click tennis button
    const tennisButtonPath = '//*[@id="home-events"]/li[2]/a';
    const [tennisButton] = await page.$x(tennisButtonPath);
    await tennisButton.click({timeout:300000});
    await delay(5000);
    ...
    page.on('response', async (response) => {
        ...
        if (url === 'https://www.allpaanel.com/api/user/gamehighlightall2') {
            ...
            for (let i = 0; i < decryptedData.length; i++) {
                ...
                const matchURL = `https://www.allpaanel.com/game-detail-other/2/${matchID}`;
                ...
                async function launchMatch() {
                    ...
                    page.on('response', async (response) => {
                        ...
                        const testTennisURL = `http://localhost:5000/tennisdata`;
