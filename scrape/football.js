    ...
    if (url === "https://www.allpaanel.com/api/user/gamehighlightall2") {
      ...
      try {
        ...
        for (let i = 0; i < decryptedData.length; i++) {
          ...
          if (etid == 1) {
            matchURL = `https://www.allpaanel.com/game-detail-other/1/${matchID}`;
            apiTag = "/api/game/getgamedata2";
            dataToServer = await page.evaluate(
              async (
                matchID,
                m,
                etid,
                ...
                const result = await fetch(apiTag, {
                  headers: {
                    ...
                    authorization:
                      "Bearer b221bcdb159109973fb08ab1b70cbb04fdec7783",
          ...
          var data1 = {dataToServer, ScoreData};
          const footballServerURL = `http://localhost:5000/soccerdata`;
          await sendToDBServer(footballServerURL, data1);
          console.log("---------------------------------------------------");
